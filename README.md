...
O projeto está dividido em main.py e em uma pasta chamada infos, possuindo 2 arquivos contendo Classes, sendo Campus, contendo as classes Campus e Endereço, e Cursos contendo Curso, Disciplinas e DisciplinasOptativas que é importado por Campus.py. Por fim o CRUD.py cria a classe CRUD que é responsável pelas funções que o sistema realizará, usando todas as outras classes.
